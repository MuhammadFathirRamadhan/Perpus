                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                              ...
                              <div class="mb-3">
                                <label for="code" class="form-label">Isbn<small>(minimal 5 karakter)</small></label>
                                <input type="text" class="form-control" id="code" name="code" value="{{ $book->code }}">
                              </div>
                              <div class="mb-3">
                                <label for="cover" class="form-label">Cover Buku <small>(maksimal 1MB)</small></label>
                              ...
                              <div class="mb-3">
                                <label for="publisher" class="form-label">Tahun Terbit</label>
